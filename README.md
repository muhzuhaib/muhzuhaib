...
A set of Python services exploring reliability in AI-backed systems — retrieval quality measured against
a stated baseline, per-run cost ceilings, and evaluation suites that gate CI rather than living in a
notebook. Links here as they land.
